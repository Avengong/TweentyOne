...
public class ReflectFiled<Type> {
    ...
    public ReflectFiled(Class<?> clazz, String fieldName) {
        if (clazz == null || fieldName == null || fieldName.length() == 0) {
            throw new IllegalArgumentException("Both of invoker and fieldName can not be null or " +
                    "nil.");
        }
        this.mClazz = clazz;
...
//            MatrixLog.w(TAG, String.format("Field %s is no exists.", mFieldName));
    ...
    public synchronized Type get(Object instance) throws NoSuchFieldException,
...
//            MatrixLog.i(TAG, "getWithoutThrow, exception occur :%s", e);
    ...
    public synchronized boolean set(Object instance, Type val) throws NoSuchFieldException,
            IllegalAccessException,
            IllegalArgumentException {
